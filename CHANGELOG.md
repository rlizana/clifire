...
### Changed
- Swapped traceback output: by default the standard Python traceback is used (more informative). The Rich pretty traceback is now shown only with the `-v` flag.
